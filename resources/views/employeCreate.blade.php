        ...
        <div class="card-body">
            ...
            <form method="post" action="{{ route('pharmacie.create') }}">
                ...
                <div class="form-group">
                    <label for="PHARMACode">Identifiant de l'employé :</label>
                    <input type="text" class="form-control" name="PHARMACode"/>
                </div>

                <div class="form-group">
                    <label for="PHARMAVille">Ville de l'employé :</label>
                    <input type="text" class="form-control" name="PHARMAVille"/>
                </div>
                <div class="form-group">
                    <label for="PHARMAAdresse">Adresse de l'employé :</label>
                    <input type="text" class="form-control" name="PHARMAAdresse"/>
                </div>
                <div class="form-group">
                    <label for="PHARMANumeroTelephone">Numéro de téléphone de l'employé :</label>
                    <input type="text" class="form-control" name="PHARMANumeroTelephone"/>
                </div>
                <div class="form-group">
                    <label for="PHARMAMail">Adresse mail de l'employé :</label>
